...
description: 'Task 3 of the Tech Writer workflow. Use to identify at a high level which deliverables (Help center, Microcopy, Pendo guides, EAP) are in or out of scope for a Cin7 Jira issue, and record a Request (refined) section.'
